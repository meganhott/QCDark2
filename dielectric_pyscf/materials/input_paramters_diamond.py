...
system_name = '/gpfs/scratch/mhott/dielectric_pyscf_results/diamond_cc-pvqz_pbe_8k'
...
lattice_vectors = [[a/2,      a/2,      0. ], 
                   [0.,       a/2,      a/2], 
                   [a/2,      0.,       a/2]]
atomloc =  ''' C 0 0 0; C {} {} {}'''.format(a/4, a/4, a/4)
mybasis = {'C': 'cc-pvqz'}        # Recommended to keep all basis sets same, however can be made different. We follow pyscf notations, see pyscf documentation
...
scissor_bandgap = 5.5              # If float in eV, the scissor correction is applied to meet the specified bandgap. If None, scissor correction is not applied
