...
lattice_vectors = [[2.829,    2.829,    0. ], 
                   [0.,       2.829,    2.829], 
                   [2.829,    0.,       2.829]]
atomloc =  '''Ge 0, 0, 0; Ge 1.4145, 1.4145, 1.4145'''
mybasis = {'Ge': 'cc-pvtz'}        # Recommended to keep all basis sets same, however can be made different. We follow pyscf notations, see pyscf documentation
...
numval = 'auto'                     # Number of valence bands to include in the calculation, use 'all' for all available valence bands
