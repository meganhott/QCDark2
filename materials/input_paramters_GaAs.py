...
system_name = 'GaAs_cc-pvdz_pbe_6k'
...
lattice_vectors = [[2.8265,    2.8265,    0. ], 
                   [0.,       2.8265,    2.8265], 
                   [2.8265,    0.,       2.8265]]
atomloc =  ''' Ga	0.	     0.	     0.    
		     As	1.41325	1.41325	1.41325'''
mybasis = {'Ga': 'cc-pvdz', 'As': 'cc-pvdz'}                            # Recommended to keep all basis sets same, however can be made different
